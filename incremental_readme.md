...
-   Layout has been reworked to create a more pleasant scrolling experience.
-   Removed the redundant control bar.
-   Changed the sample images. (no more MTG cards aw)

**AHA! Moment**

-   if Avery is the Control Unit, then
-   Justin (me) is the Arithmetic Logic Unit
-   Paul is the Cache memory
-   Prince is the Main memory
-   Kei is the Buses
...
-   Added references at the end of the Home Page

**Challenges**

-   Couldn't figure out mobile compatibility

---

## Milestones Accomplished by Final Submission
